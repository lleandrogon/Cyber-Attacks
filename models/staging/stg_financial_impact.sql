WITH source AS (
    SELECT
        ...
        CAST(total_loss_method AS CHAR(30)) AS total_loss_method,
        ...
        CAST(cpi_index_used AS CHAR(40)) AS cpi_index_used,
        notes,
        created_at,
        updated_at
